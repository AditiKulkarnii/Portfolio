...
import pdf from "../../Assets/Resume_Aditi_final.pdf";
      ...
      <Container>
        ...
        <Row className="resume">
          ...
          <Col md={6} className="resume-right">
            ...
            <Resumecontent
              title="BTech - Information Technology [Birla vishwakarma Mahavidyalaya]"
              date="2017 - 2021"
              content={[
                `CGPA: 7.87/10 `,
                "Currently a final year student pursuing BTech in IT from BVM.",
              ]}
            />
